...
const SECONDARY_LINK_CLASS =
  'inline-flex items-center justify-center gap-2 rounded-xl border border-taupe-200 bg-taupe-50 px-5 py-3 text-sm font-semibold text-muted transition-colors hover:border-plum-500 hover:bg-taupe-100';
    ...
    <>
      <BentoCard span={2} rows={2} className="flex flex-col justify-between p-7 md:p-9">
        <div>
          ...
          <p className="mt-2 text-sm text-muted/75">{t('freelanceNote')}</p>
        </div>
      ...
      <BentoCard span={2} rows={2} tone="tint" className="flex flex-col justify-center gap-4 p-7 md:p-8">
        ...
        >
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-taupe-100 text-muted transition-colors group-hover:bg-plum-500 group-hover:text-white">
