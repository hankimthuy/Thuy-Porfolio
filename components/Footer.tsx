        ...
        <div className="flex items-start gap-[60px] mb-[80px]">
          <div className="flex-1">
            ...
            <div className="flex gap-[18px]">
              <a 
                ...
                className="bg-[#1D2130] text-white px-[24px] py-[17px] rounded-[12.8px] text-[18px] font-semibold flex items-center gap-[5px] hover:bg-[#6dd0d9] transition-colors w-fit"
              >
                My Linkedin
              </a>
              <a 
          ...
          <div className="flex-1 bg-[#583FBC] rounded-[32px] p-[42px] relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <a 
                href="#contact"
                className="bg-[#A6B1E1] text-white px-[24px] py-[17px] rounded-[12.8px] text-[18px] font-semibold flex items-center gap-[5px] hover:bg-[#6dd0d9] transition-colors w-fit"
              >
                Get in Touch
