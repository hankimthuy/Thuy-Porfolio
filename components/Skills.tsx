...
export default function Skills() {
  ...
  const skills = t.raw('cards') as Array<{ title: string; description: string }>;
  ...
  const getTechIcon = (name: string) => {
    switch (name) {
      case 'Angular':
        return <FaAngular style={{ width: '100%', height: '100%' }} color="white" />;
      case 'React':
        return <FaReact style={{ width: '100%', height: '100%' }} color="white" />;
      case 'Figma':
        return (
      ...
      case 'Spring Boot':
        return <SiSpring style={{ width: '100%', height: '100%' }} color="white" />;
      case 'AI':
        return <LuBrain style={{ width: '100%', height: '100%' }} color="white" />;
      default:
        return null;
    }
  };
        ...
        <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-start lg:gap-10">
          <div className="relative flex items-center justify-center flex-shrink-0 w-[260px] h-[260px] sm:w-[300px] sm:h-[300px] lg:w-[500px] lg:h-[500px]">
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-[220px] h-[220px] lg:w-[380px] lg:h-[380px] border border-slate-200 rounded-full absolute transform rotate-[25deg] scale-y-90" />
              <div className="w-[220px] h-[220px] lg:w-[380px] lg:h-[380px] border border-slate-200 rounded-full absolute transform -rotate-[25deg] scale-y-90" />
              <div className="w-[270px] h-[270px] lg:w-[450px] lg:h-[450px] border border-slate-100 rounded-full absolute opacity-50" />
            </div>
            ...
            {techIconsConfig.map((tech, index) => {
              ...
              return (
                <div
                  ...
                  title={tech.name}
                >
                  <div style={{ width: svgSize, height: svgSize }}>{getTechIcon(tech.name)}</div>
                </div>
              );
            })}
          </div>
